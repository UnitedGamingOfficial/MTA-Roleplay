...
function ckPlayer(thePlayer, commandName, targetPlayer, ...)
		if not (targetPlayer) or not (...) then
			...
			if targetPlayer then
				if thePlayer ~= targetPlayer and not exports.global:isPlayerLeadAdmin(thePlayer) then
					outputChatBox("You are not authorized to CK this player.", thePlayer, 255, 0, 0)
					return
				end
