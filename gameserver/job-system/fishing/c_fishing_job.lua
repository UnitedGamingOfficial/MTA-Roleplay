...
local function showFishMarker(msg)
	if not (fishingBlip) then -- If the /sellfish marker isnt already being shown...
		fishingBlip = createBlip(-1477.6279296875, 483.654296875, 1.1774253845215, 0, 2, 255, 0, 255, 255 )
		fishingMarker = createMarker(-1477.6279296875, 483.654296875, 1.1774253845215, "cylinder", 2, 255, 0, 255, 150 )
		fishingCol = createColSphere (-1477.6279296875, 483.654296875, 1.1774253845215, 3)
		if msg == 1 then
