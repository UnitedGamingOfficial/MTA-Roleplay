function cPayDay(faction, pay, profit, interest, donatormoney, tax, incomeTax, vtax, ptax, rent, grossincome)
	...
	-- bank interest
	if (interest > 0) then
		outputChatBox("    Bank Interest: #00FF00$" .. exports.global:formatMoney(interest) .. " (" ..tonumber(Perc).. "%)",255, 194, 14, true)
	end
	...
	-- income tax
	if (tax > 0) then
		outputChatBox("    Income Tax of " .. (math.ceil(incomeTax*100)) .. "%: #FF0000$" .. exports.global:formatMoney(tax), 255, 194, 14, true)
	end
