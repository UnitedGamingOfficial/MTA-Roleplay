...
function theftPost(noteEdit, EngineCheck, KeyCheck, targetPlayerName, targetVehicle, targetPlayer, SellVehCheck, ChangeLockCheck)
	...
	if EngineCheck then
		...
		exports['anticheat-system']:changeProtectedElementDataEx(theVehicle, "engine", 1, false)
		exports['anticheat-system']:changeProtectedElementDataEx(theVehicle, "handbrake", 0, false)
		enginestarted = "Yes."
	...
	for k, v in ipairs(exports.global:getAdmins()) do
		...
		outputChatBox("[VT-POST] Theft post successfully created: http://www.unitedgaming.org/forums/showthread.php/6205-Vehicle-Thefts?p="..postID.."#post"..postID..".", v, 250, 217, 5)
		end
	end
end
