...
interiors = { 	
	...
	[120] = { 23,  1806.75, -2454.64,   13.56, 0 , "Beach Huts (Callum)"  }, -- 121 Beach Huts (Callum)
	...
	--[143] = { 10, 322.75504, -96.3672, 997.93127, 0 , "Unnamed"  }, -- 143 Small Casino + Backroom by Diuvel, Sketchead, McNitro and rjm (Maxime) --Bugged
} 
...
function printInteriorsList(thePlayer, commandName,  from, to )
	...
	local count = 0
	local linkForum = "http://www.unitedgaming.org/forums/showthread.php/2666"
