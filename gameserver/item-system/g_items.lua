g_items = {	
	...
	[34] = { "Cocaine", "A powder-like substance with strong effects.", 3, 1575, 0, 0, 0, 0, weight = 0.1 },
	[35] = { "Morphine", "A pill or liquid substance with strong effects.", 3, 1578, 0, 0, 0, -0.02, weight = 0.1 },
	[36] = { "Ecstasy", "Pills with strong effects.", 3, 1576, 0, 0, 0, 0.07, weight = 0.1 },
	[37] = { "Heroin", "A pill or liquid substance with strong effects.", 3, 1579, 0, 0, 0, 0, weight = 0.1 },
	[38] = { "Marijuana", "Marijuana.", 3, 3044, 0, 0, 0, 0.04, weight = 0.1 }, 
	[39] = { "Methamphetamine", "A crystal-like substance with strong effects.", 3, 1580, 0, 0, 0, 0, weight = 0.1 },
	[40] = { "Epinephrine (Adrenaline)", "Epinephrine - a liquid substance that boosts adrenaline.", 3, 1575, 0, 0, 0, -0.02, weight = 0.1 },
	[41] = { "LSD", "Lysergic acid with diethylamide.", 3, 1576, 0, 0, 0, 0, weight = 0.1 },
	[42] = { "Shrooms", "Magical mushrooms.", 3, 1577, 0, 0, 0, 0, weight = 0.1 },
	...
	[64] = { "LSPD Badge", "A Los Santos Police Department badge.", 4, 1581, 270, 270, 0, 0, weight = 0.3 },
	[65] = { "LSES Badge", "A Los Santos Emergency Services badge.", 4, 1581, 270, 270, 0, 0, weight = 0.3 },
	[66] = { "Blindfold", "A black blindfold.", 6, 2386, 0, 0, 0, 0.1, weight = 0.1 },
	[67] = { "GPS", "A GPS Satnav for a car.", 6, 1210, 270, 0, 0, 0.1, weight = 0.8 },
	...
	[82] = { "LST&R Identification", "This LST&R Identification has been issued to #v.", 4, 1581, 270, 270, 0, 0, weight = 0.3 },
	...
	[86] = { "SANN Identifcation", "A SANN Identification issued to #v.", 7, 330, 90, 90, 0, -0.05, weight = 0.3 },
	...
	[112] = { "SASP Badge", "A San Andreas State Police badge.", 4, 1581, 270, 270, 0, 0, weight = 0.3 }, -- 142
	...
	[115] = { "Weapon", "#v ", 8, 2886, 270, 0, 1, 0.1, 2, weight = function( v ) local weaponID = tonumber( explode(":", v)[1] ) return weaponID and weaponweights[ weaponID ] or 1 end }, -- 115
	...
	[119] = { "Sanitary Andreas ID", "A Sanitary Andreas Identification Card.", 6, 1210, 270, 0, 0, 0.1, weight = 0.2 }, -- 119
	...
	[127] = { "LSIA ID", "An LSIA Identification ID.", 7, 1581, 270, 270, 0, 0, weight = 0.3 }, --127
	[128] = { "SFHR ID", "A SFHR ID.", 7, 1581, 270, 270, 0, 0, weight = 0.3 }, --128
	[129] = { "Direct Imports ID", "A Direct Imports ID.", 7, 1581, 270, 270, 0, 0, weight = 0.3 }, --129
	[130] = { "Vehicle Alarm System", "A vehicle alarm system.", 6, 1210, 270, 0, 0, 0.1, weight = 0.3 }, -- 130
	[131] = { "Volkswagen AG ID", "A Volkswagen AG ID.", 4, 1581, 270, 270, 0, 0, weight = 0.5 }, -- 131
	[132] = { "Prescription Bottle", "A prescription bottle, contains prescription medicine.", 3, 1575, 0, 0, 0, 0.04, weight = 0.1 }, --132
	[133] = { "Driving License", "A Los Santos driving license.", 10, 1581, 0, 0, 0, 0.04, weight = 0.1 }, -- 133
	[134] = { "Money", "Los Santos currency.", 10, 1212, 0, 0, 0, 0.04, weight = 0.1 }, -- 134
	...
	[142] = { "Los Santos Cab & Bus ID", "A Los Santos Cab & Bus Identification Card.", 6, 1210, 270, 0, 0, 0.1, weight = 0.3 }, -- 142
	...
	[146] = { "Los Santos District Court Identification Card", "A Los Santos District Court Badge", 4, 1581, 270, 270, 0, 0, weight = 0.3 }, --146
...
function getBadges( )
	return {
		...
		[64]  = { "LSPD badge", 		"a LSPD badge",			{[1] = true},				 	{0,100,255},	2},
		[112]  = { "SASP badge", 		"a SASP badge",			{[45] = true},				 	{68,150,255},	2},
		[65]  = { "LSES badge", 		"a LS badge", {[2] = "SFES"},	    {175,50,50},	1},
		[86]  = { "SANN badge",		"a SANN ID",				{[6] = true},					{150,150,255},	1},
		[87]  = { "GOV badge",		"a Government badge",		{[3] = true},					{50,150,50},	1},
		[82]  = { "LST&R ID",			"a LST&R ID",			{[4] = true},					{0,238,0},		1},
		--[112] = { "LSC&B ID",	"a LS Cab & Bus ID",		{[87] = true},					{255,238,0},	2},
		...
		[127] = { "LSIA ID",		"an LSIA ID",	{[15] = true},	{18,189,183},	1},
		[128] = { "SFHR ID",		"an SFHR ID",	{[18] = true},	{3,237,237},	1},
		[129] = { "Direct Imports ID",		"a Direct Imports ID",	{[7] = true},	{88, 130, 250},	1},
		[131] = { "Volkswagen AG ID",        "a Volkswagen AG ID",                {[29] = true},                    {0,185,245},    1},
