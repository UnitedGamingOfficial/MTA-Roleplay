-- the office guy
local ped = createPed(240, 359.7138671875, 173.5673828125, 1008.3893432617)
setElementInterior(ped, 3)
setElementDimension(ped, 86)
setPedRotation(ped, 271)
--setPedAnimation( ped, "FOOD", "FF_Sit_Look", -1, true, false, false )
setElementData( ped, "talk", 1, false )
setElementData( ped, "name", "Johnny Johnson", false )
...
function showImpoundUI(vehElementsret)
	if not wImpound then
		...
		lCost = guiCreateLabel(0.3, 0.85, 0.2, 0.1, "Cost: $250.00", true, wImpound)
		...
		outputChatBox("Welcome to the LST&R Impound Lot.")
	end
end
