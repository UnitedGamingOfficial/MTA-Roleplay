...
function forcedAnim()
	exports['anticheat-system']:changeProtectedElementDataEx(source, "forcedanimation", 1, false)
end
...
-- /daps animtion -------------------------------------------------
function handshakeAnimation(thePlayer, cmd, otherPlayer)
	local logged = getElementData(thePlayer, "loggedin")
	local otherPlayer = exports.global:findPlayerByPartialNick(thePlayer, otherPlayer)
