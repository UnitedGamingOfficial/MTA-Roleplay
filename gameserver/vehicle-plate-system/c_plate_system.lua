...
local gabby = createPed(150, 1493.33203125, 1594.283203125, 11.051704406738)
--setPedRotation(gabby, 266.27145385742) -- Old Rotation
setPedRotation(gabby, 269.5166015625)
setElementDimension(gabby, 1316)
setElementInterior(gabby, 1)
