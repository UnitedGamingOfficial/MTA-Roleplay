...
g_shops = {
	{ -- 1
		...
		{
			name = "General Items",
			{ name = "Lottery Ticket", description = "A ticket that can make you or break you.", price = 10, itemID = 68, itemValue = nil },
...
--			{ name = "Phonebook", description = "A large phonebook of everyones phone numbers.", price = 30, itemID = 7 },
			...
			{ name = "Flashlight", description = "Lights up the environment.", price = 24, itemID = 145 },
		},
		{
			name = "Consumable",
	...
	{ -- 17
		name = "Custom Store - It's ok now to make it for players. -Maxime",
		description = " ",
		image = "general.png",
	},
