 ...
 *  VERION HISTORY:
 *  
 *		v1.1.0 [10.23.2010] - PHP 5.3.0 compatible - Patrick Rombouts
 *		v1.0.0 [04.16.2005] - Initial Version - Micah Carrick
 *
 *******************************************************************************
 *  DESCRIPTION:
 *
...
class paypal_class {
	...
	function validate_ipn() {
		...
		$pos = strpos($this->ipn_response,'VERIFIED');
