...
// start flash stuff
$flash = array();
function addFlashObject($name, $divtag, $width, $height, $preloader)
{
	global $flash;
	$flash[] = array ($name, $divtag, $width, $height, $preloader);
}
// end flash stuff
...
class fileCache {
	...
	public function fileCache($exp_time=600,$path="cache/"){
